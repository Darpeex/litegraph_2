...
const shemeSchema = new mongoose.Schema(
  {
    ...
    thumbnail: {
      // миниатюрное изображение постера к схемыу
      type: String,
    ...
    owner: {
      // _id пользователя, который сохранил схемы.
      type: mongoose.Schema.Types.ObjectId, // тип данных для работы с идентификаторами(ObjectId)
      required: [true, 'Поле "owner" должно быть заполнено'],
      ref: 'User',
    },
    shemeId: {
      // id схемы, который содержится в ответе сервиса shemesExplorer
      type: Number,
      required: [true, 'Поле "shemeId" должно быть заполнено'],
    },
    nameRU: {
      // название схемы на русском языке
      type: String,
      required: [true, 'Поле "nameRU" должно быть заполнено'],
    },
    nameEN: {
      // название схемы на английском языке
      type: String,
