...
function InputsPorts({ node, toggle, setToggle }) {
  ...
  const handleAddInput = () => {
    ...
    // обновляем массив, добавляя новую ссылку
  ...
  // Функция для обновления имени порта и установки фокуса
  const handleInputNameChange = (input, newName) => {
    input.name = newName;
    // устанавливаем фокус обратно на элемент ввода после его обновления
    if (inputRef.current) {
